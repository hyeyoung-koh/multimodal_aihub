    ...
    with open('D:\\json_file_list\\clip_' + k + '.json', 'r', encoding='utf-8-sig') as input_file, open('D:\\json_file_list\\clip_' + k + '_final_20220105bbbb.csv', 'w', newline='', encoding='cp949') as output_file:
        ...
        for key,value in data['data'].items():
            ...
            for m in dkeys:
                ...
                print(a)
                try:
                    fo.writerow([data['data'][a]['2']['person_id'],
                    ...
                    pass
                try:
                    fo.writerow([data['data'][a]['1']['person_id'],
...
df_process.to_csv('D:\\json_file_list\\clip_' + k + 'csvfile_20220105_kkkkko.csv', encoding='cp949')
