...
f=open('D:\\json_file_list\\clip_50.json','rt',encoding='UTF-8')
...
with open('D:\\json_file_list\\clip_50.json','r',encoding='UTF-8') as input_file,open('clip_50_0104.csv','w',newline='',encoding='UTF-8') as output_file:
...
df_process=pd.read_csv('clip_50_0104.csv',encoding='utf-8')
df_process.drop_duplicates(subset=None,keep='first',inplace=True,ignore_index=True)

df_process.to_csv('clip_50_drop_duplicate_0104.csv',encoding='utf-8-sig')
