...
f=open('D:\\json_file_list\\clip_1604.json','r', encoding='utf-8-sig') #rt


#ourdata=f.replace(("\'","\""))
data=json.load(f.replace("'","\""))
print(data)
...
with open('D:\\json_file_list\\clip_1604.json','r',encoding='utf-8-sig') as input_file,open('clip_1604_final_out3.csv','w',newline='',encoding='utf-8-sig') as output_file:
...
df_process=pd.read_csv('clip_1604_final_out3.csv',encoding='utf-8-sig')
df_process.drop_duplicates(subset=None,keep='first',inplace=True,ignore_index=True)
df_process.to_csv('clip_1604_csvfile_final.csv',encoding='utf-8-sig')
