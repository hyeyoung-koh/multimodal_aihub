...
with open('clip_1.json','r',encoding='utf-8') as input_file,open('clip_1_4.csv','w',newline='') as output_file:
    ...
    #for datum in data:
    #사람1
    n=[31,211,423,656,851] #얘는 text_script_start를 의미한다.
    i=0
    for i in range(len(n)):
        ...
        f.writerow([data['data'][j]['1']['person_id'],
                   ...
                   data['data'][j]['1']['emotion']['multimodal']['valence'],
                    ...
                    data['data'][j]['1']['text']['script'],data['data'][j]['1']['text']['intent']])
        i+=1
    #사람2
    n2=[141,331,531,741,966]
    k=0
